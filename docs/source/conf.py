# -*- coding: utf-8 -*-
#
# rpymostat-common documentation build configuration file, created by
...
if is_rtd:
    ...
    htmlhelp_basename = 'rpymostat-commondoc'
...
latex_documents = [
  (master_doc, 'rpymostat-common.tex', u'rpymostat-common Documentation',
...
man_pages = [
    (master_doc, 'rpymostat-common', u'rpymostat-common Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'rpymostat-common', u'rpymostat-common Documentation',
   author, 'rpymostat-common', 'One line description of project.',
   'Miscellaneous'),
]
